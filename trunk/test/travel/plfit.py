...
class plfit:
    ...
    def plotcdf(self,x=None,xmin=None,alpha=None,**kwargs):
        ...
        pylab.gca().set_xlim(auto=True)
        pylab.gca().set_ylim(auto=True)
        pylab.loglog(x,xcdf,'o',color='b',alpha='0.5',mec='b',mew='4',mfc='w', ms=8,**kwargs)
        pylab.loglog(plotx,ploty,'k--',**kwargs)
...
if __name__=="__main__":
    ...
    pl = plfit(data,quiet=False)
    pl.plfit()
    pl.plotcdf(data,pl._xmin,pl._alpha)
    #pl.plotpdf(data,pl._xmin,pl._alpha)
    #pl.plotppf(numpy.array(data),pl._xmin,pl._alpha)
